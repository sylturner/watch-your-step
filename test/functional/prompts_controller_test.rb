...
class PromptsControllerTest < ActionController::TestCase
  ...
  test "should create prompt" do
    assert_difference('Prompt.count') do
      post :create, prompt: { answer: @prompt.answer, medium_id: @prompt.medium_id, question: @prompt.question }
    end
  ...
  test "should update prompt" do
    put :update, id: @prompt, prompt: { answer: @prompt.answer, medium_id: @prompt.medium_id, question: @prompt.question }
    assert_redirected_to prompt_path(assigns(:prompt))
  end
